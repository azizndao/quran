  ...
  fun getQariList(): List<Qari> {
    return listOf(
      ...
      Qari(
        ...
        imageUrl = "https://quran-data-alpha.vercel.app/images/2.png",
...
//      ),
      Qari(
        ...
        imageUrl = "https://quran-data-alpha.vercel.app/images/8.png",
...
//      ),
      ...
      Qari(
        ...
        imageUrl = "https://quran-data-alpha.vercel.app/images/33.png",
      ...
      Qari(
        id = 9,
        slug = "sa3d_alghamidi",
        imageUrl = "https://quran-data-alpha.vercel.app/images/9.png",
      ...
      Qari(
        ...
        imageUrl = "https://quran-data-alpha.vercel.app/images/4.png",
      ...
      Qari(
        id = 11,
        slug = "shatri",
        imageUrl = "https://quran-data-alpha.vercel.app/images/6.png",
      ...
      Qari(
        ...
        imageUrl = "https://quran-data-alpha.vercel.app/images/3.png",
      ...
      Qari(
        id = 12,
        slug = "ahmed_al3ajamy",
        imageUrl = "https://quran-data-alpha.vercel.app/images/7.png",
      ...
      Qari(
        id = 14,
        slug = "hani_rifai",
        imageUrl = "https://quran-data-alpha.vercel.app/images/10.png",
      ...
      Qari(
        id = 15,
        slug = "husary",
        imageUrl = "https://quran-data-alpha.vercel.app/images/11.png",
        nameResource = R.string.qari_husary_gapless,
        url = "https://download.quranicaudio.com/quran/mahmood_khaleel_al-husaree",
      ),
      Qari(
        id = 16,
        slug = "ali_hudhayfi",
        imageUrl = "https://quran-data-alpha.vercel.app/images/13.png",
      ...
      Qari(
        ...
        imageUrl = "https://quran-data-alpha.vercel.app/images/14.png",
      ...
      Qari(
        id = 18,
        slug = "muaiqly_kfgqpc",
        imageUrl = "https://quran-data-alpha.vercel.app/images/15.png",
      ...
      Qari(
        ...
        imageUrl = "https://quran-data-alpha.vercel.app/images/19.png",
      ...
      Qari(
        ...
        imageUrl = "https://quran-data-alpha.vercel.app/images/20.png",
      ...
      Qari(
        id = 21,
        slug = "mjibreel",
        imageUrl = "https://quran-data-alpha.vercel.app/images/21.png",
      ...
      Qari(
        id = 22,
        slug = "salah_bukhatir",
        imageUrl = "https://quran-data-alpha.vercel.app/images/29.png",
      ...
      Qari(
        ...
        imageUrl = "https://quran-data-alpha.vercel.app/images/30.png",
      ...
      Qari(
        ...
        imageUrl = "https://quran-data-alpha.vercel.app/images/31.png",
      ...
      Qari(
        id = 25,
        slug = "salah_budair",
        imageUrl = "https://quran-data-alpha.vercel.app/images/32.png",
      ...
      Qari(
        id = 26,
        slug = "ahmad_nauina",
        imageUrl = "https://quran-data-alpha.vercel.app/images/34.png",
      ...
      Qari(
        id = 28,
        slug = "khalifa_taniji",
        imageUrl = "https://quran-data-alpha.vercel.app/images/36.png",
      ...
      Qari(
        ...
        imageUrl = "https://quran-data-alpha.vercel.app/images/37.png",
      ...
      Qari(
        id = 30,
        slug = "husary_muallim",
        imageUrl = "https://quran-data-alpha.vercel.app/images/41.png",
      ...
      Qari(
        ...
        imageUrl = "https://quran-data-alpha.vercel.app/images/42.png",
      ...
      Qari(
        id = 32,
        slug = "yasser_dussary",
        imageUrl = "https://quran-data-alpha.vercel.app/images/43.png",
      ...
      Qari(
        id = 34,
        slug = "qatami",
        imageUrl = "https://quran-data-alpha.vercel.app/images/44.png",
      ...
      Qari(
        ...
        imageUrl = "https://quran-data-alpha.vercel.app/images/45.png",
      ...
      Qari(
        id = 35,
        slug = "yasser_dussary",
        imageUrl = "https://quran-data-alpha.vercel.app/images/46.png",
        nameResource = R.string.qari_yasser_dussary_gapless,
      ...
      Qari(
        id = 36,
        slug = "aziz_alili",
        imageUrl = "https://quran-data-alpha.vercel.app/images/49.png",
      ...
      Qari(
        ...
        imageUrl = "https://quran-data-alpha.vercel.app/images/51.png",
      ...
      Qari(
        id = 38,
        slug = "fares_abbad",
        imageUrl = "https://quran-data-alpha.vercel.app/images/52.png",
      ...
      Qari(
        id = 39,
        slug = "ibrahim_walk",
        imageUrl = "https://quran-data-alpha.vercel.app/images/23.png",
