...
class QariPreviewParameterProvider : PreviewParameterProvider<Qari> {
  override val values: Sequence<Qari> = sequenceOf(
    Qari(
      id = 0,
      nameResource = org.quran.audio.R.string.qari_minshawi_murattal_gapless,
      url = "https://download.quranicaudio.com/quran/muhammad_siddeeq_al-minshaawee",
      slug = "minshawi_murattal",
    ),
    Qari(
      id = 1,
      nameResource = org.quran.audio.R.string.qari_husary_gapless,
    ...
    Qari(
      ...
      nameResource = org.quran.audio.R.string.qari_abdulbaset_mujawwad_gapless,
    ...
    Qari(
      ...
      image = "https://raw.githubusercontent.com/azizndao/quran_data/dev/images/2.png",
      nameResource = org.quran.audio.R.string.qari_abdulbaset_gapless,
    ...
    Qari(
      ...
      nameResource = org.quran.audio.R.string.qari_afasy_gapless,
    ...
    Qari(
      ...
      image = "https://raw.githubusercontent.com/azizndao/quran_data/dev/images/8.png",
      nameResource = org.quran.audio.R.string.qari_afasy_cali_gapless,
